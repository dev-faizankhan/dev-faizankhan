...
**🌟 Professional Full Stack Developer** with **5+ years** of experience crafting high-performing web, mobile, and desktop applications. Founder & Full-Stack Developer at **[MetaPixus](https://metapixus.com)** 🏢 (my startup), where I build products end to end and lead a small team. I'm also available for freelance, working remotely with clients worldwide from Karachi 🌍.
...
👉 **See my work:** [dev-faizankhan.github.io](https://dev-faizankhan.github.io)
...
const faizanKhan = {
  ...
  experience: "5+ years",
  currentRole: "Founder & Developer at MetaPixus (my startup)",
  ...
  portfolio: "https://dev-faizankhan.github.io",
...
> Full case studies with screenshots on my portfolio → **[dev-faizankhan.github.io](https://dev-faizankhan.github.io)**

| Project | What it is | Tech | Links |
| --- | --- | --- | --- |
| **MediFlow** | Pharmacy & medical-store management system (inventory, POS, accounting, multi-branch) | React 19 · TypeScript · FastAPI · PostgreSQL | [Case study](https://dev-faizankhan.github.io/projects/mediflow) |
| **Traders Arena** | Real-time trading-competition platform with live leaderboards & payments | Next.js · Convex · Clerk · MT5 | [Live](https://tradersarena.io) · [Case study](https://dev-faizankhan.github.io/projects/traders-arena) |
| **ARC Insurance** | Policyholder mobile app (policies, premiums, requests, chat) | React Native · Redux Toolkit · Firebase | [Play Store](https://play.google.com/store/apps/details?id=com.arcinsurance) · [Case study](https://dev-faizankhan.github.io/projects/arc) |
| **FMI Learning** | Math-practice learning app for students & teachers | React Native · Firebase · Firestore | [Case study](https://dev-faizankhan.github.io/projects/fmi) |
| **Helical Analytics** | Clinical-trial data platform with DICOM imaging at scale | React · Electron · Fastify · AWS S3 | [Case study](https://dev-faizankhan.github.io/projects/helical) |

---

## 🌟 Current Focus & Goals

🔭 **Currently Working On:** Next-generation applications at MetaPixus (my startup) and client/freelance projects  
